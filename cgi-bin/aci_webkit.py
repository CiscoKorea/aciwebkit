    ...
    <div class="circleStats row hideInIE8">
        <div class="col-md-3 col-sm-4 col-xs-6">
            <div class="circleStatsItemBox">
                ...
                <span class="plus">percent</span>
                <div class="circleStat">
                    <input type="text" value="@fvTenant_cnt" class="whiteCircle" />
                </div>      
                <div class="footer">
                    <span class="count">
    ...
    if nid is None:
        ...
        for pod in pods:
            ...
            for id, node in sorted(nodes_new.items()):
                ids.append(id)
                node_url = 'http://' + re.sub(r'&nid.*$', "", URL) + '&nid=' + id
                data = data + '<button type=\"button\" class=\"btn btn-default\" id=\"nid_' + id + '\"><a href=\"' + node_url + '\">' + id + '</a></button>'
